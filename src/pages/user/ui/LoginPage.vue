<!-- src/pages/user/ui/LoginPage.vue -->
...
import { useNotifier } from '@shared/lib'
  ...
  <section class="max-w-sm mx-auto mt-20 p-6 bg-white rounded-xl shadow ring-1 ring-gray-200">
    ...
    <form @submit.prevent="onSubmit" class="flex flex-col gap-4">
      <input
        ...
        :class="{ 'ring-red-300 border-red-300': emailMeta.touched && emailError }"
      />
      ...
      <input
        ...
        class="border rounded-lg px-3 py-2"
        :class="{ 'ring-red-300 border-red-300': passwordMeta.touched && passwordError }"
      />

<!-- src/pages/user/ui/OrdersPage.vue -->
...
<template>
  <div class="max-w-4xl mx-auto py-8 px-4">
    ...
    <BaseLoader v-if="orders.loading" />
    ...
    <div v-else>
      <div v-if="list.length">
        ...
        >
          ...
          <footer class="flex flex-wrap gap-3 justify-between text-sm text-gray-600 mt-3 border-t pt-2">
      ...
      <div v-else class="text-center py-12 text-gray-400">
        ...
        <RouterLink to="/catalog/men" class="text-blue-500 hover:underline">Перейти в каталог</RouterLink>
      </div>
    </div>
  </div>
</template>
